...
def get_generate_student(request):
    student = Student.objects.create(first_name=faker.first_name(), last_name=faker.last_name(), age=faker.random_int(18, 100))
    return HttpResponse(f"{student.id}, {student.first_name}, {student.last_name}, {student.age}")
